(function (g, f, b, e, c, d, q) {/*! Jssor */
    ...
    var l = g.$JssorEasing$ = {$EaseLinear: function (a) {
    ...
    }}, i = g.$JssorDirection$ = {$TO_LEFT: 1, $TO_RIGHT: 2, $TO_TOP: 4, $TO_BOTTOM: 8, $HORIZONTAL: 3, $VERTICAL: 12, $LEFTRIGHT: 3, $TOPBOTOM: 12, $TOPLEFT: 5, $TOPRIGHT: 6, $BOTTOMLEFT: 9, $BOTTOMRIGHT: 10, $AROUND: 15, $GetDirectionHorizontal: function (a) {
        return a & 3
        ...
        return(a & 12) > 0
    }}, r = {$BACKSPACE: 8, $COMMA: 188, $DELETE: 46, $DOWN: 40, $END: 35, $ENTER: 13, $ESCAPE: 27, $HOME: 36, $LEFT: 37, $NUMPAD_ADD: 107, $NUMPAD_DECIMAL: 110, $NUMPAD_DIVIDE: 111, $NUMPAD_ENTER: 108, $NUMPAD_MULTIPLY: 106, $NUMPAD_SUBTRACT: 109, $PAGE_DOWN: 34, $PAGE_UP: 33, $PERIOD: 190, $RIGHT: 39, $SPACE: 32, $TAB: 9, $UP: 38}, o, n = {$UNKNOWN: 0, $IE: 1, $FIREFOX: 2, $SAFARI: 3, $CHROME: 4, $OPERA: 5}, z = 1, v = 2, x = 3, w = 4, y = 5, j, a = g.$JssorUtils$ = new function () {
        var i = this, m = n.$UNKNOWN, j = 0, s = 0, T = 0, B = 0, fb = navigator.appName, k = navigator.userAgent;

        function F() {
            if (!m)if (fb == "Microsoft Internet Explorer" && !!g.attachEvent && !!g.ActiveXObject) {
                var d = k.indexOf("MSIE");
                m = n.$IE;
                s = parseFloat(k.substring(d + 5, k.indexOf(";", d)));
                /*@cc_on T=@_jscript_version@*/
                ;
                j = f.documentMode || s
                ...
                if (b >= 0)B = parseFloat(k.substring(b + 12))
            } else {
        ...
        function C(a) {
            return a == e ? String(a) : ob()[db(a)] || "object"
        }

        function pb(a) {
            if (!a || C(a) !== "object" || a.nodeType || i.$IsWindow(a))return d;
        ...
        function ib(b, a, c) {
            if (T < 9) {
                var e = b.style.filter, g = new RegExp(/[\s]*progid:DXImageTransform\.Microsoft\.Matrix\([^\)]*\)/g), f = a ? "progid:DXImageTransform.Microsoft.Matrix(M11=" + a[0][0] + ", M12=" + a[0][1] + ", M21=" + a[1][0] + ", M22=" + a[1][1] + ", SizingMethod='auto expand')" : "", d = K(e, [g], f);
                ab(b, d);
        ...
        i.$IsBrowserIE = r;
        i.$IsBrowserIeQuirks = I;
        i.$IsBrowserFireFox = Z;
        i.$IsBrowserSafari = O;
        i.$IsBrowserChrome = lb;
        i.$IsBrowserOpera = nb;
        i.$IsBrowserBadTransform = V;
        i.$IsBrowserSafeHWA = hb;
        ...
        i.$GetMousePosition = function (a) {
            a = i.$GetEvent(a);
            var b = new h;
            if (a.type == "DOMMouseScroll" && Z() && j < 3) {
                b.x = a.screenX;
                b.y = a.screenY
        ...
        i.$GetWindowSize = function (c) {
            var a = new h, b = I() ? c.document.body : c.document.documentElement;
            a.x = b.clientWidth;
            a.y = b.clientHeight;
            return a
        };
        function G(c, d, a) {
            if (a != q)c.style[d] = a; else {
        ...
        function S(g, c) {
            ...
            if (A()) {
                var k = i.$CreateMatrix(f / 180 * b.PI, d, d);
                ib(g, !f && d == 1 ? e : k, i.$GetMatrixOffset(k, c.$OriginalWidth, c.$OriginalHeight))
            } else {
                var h = t(g);
                if (h) {
                    var j = "rotate(" + f % 360 + "deg) scale(" + d + ")";
                    if (a.$IsBrowserChrome() && B > 535)j += " perspective(2000px)";
                    g.style[h] = j
                }
            }
        }
        ...
        i.$SetStyleTransform = function (b, a) {
            if (V())eb(i.$CreateCallback(e, S, b, a)); else S(b, a)
        };
        ...
        i.$SetStyleScale = function (a, c) {
            if (r() && s < 9 || s < 10 && I())a.style.zoom = c == 1 ? "" : c; else {
                var b = t(a);
                if (b) {
                    var f = "scale(" + c + ")", e = a.style[b], g = new RegExp(/[\s]*scale\(.*?\)/g), d = K(e, [g], f);
                    a.style[b] = d
                }
            }
        };
        ...
        function gb(g) {
            var f = c, a = I() ? g.document.body : g.document.documentElement;
            if (a) {
                var e = a.offsetWidth - cb, b = a.offsetHeight - bb;
                if (e || b) {
                    cb += e;
                    bb += b
                } else f = d
        ...
        i.$AddEventBrowserMouseUp = function (b, a) {
            i.$AddEvent(A() ? f : g, "mouseup", b, a)
        };
        i.$RemoveEventBrowserMouseUp = function (b, a) {
            i.$RemoveEvent(A() ? f : g, "mouseup", b, a)
        };
        i.$AddEventBrowserMouseDown = function (b, a) {
            i.$AddEvent(A() ? f : g, "mousedown", b, a)
        };
        i.$RemoveEventBrowserMouseDown = function (b, a) {
            i.$RemoveEvent(A() ? f : g, "mousedown", b, a)
        };
        ...
        function R(a, c, b, f) {
            ...
            for (a = a ? a.firstChild : e; a; a = a.nextSibling)if (a.nodeType == 1) {
                if (i.$GetAttributeEx(a, b) == c)return a;
                if (f) {
                    var d = R(a, c, b, f);
                    if (d)return d
                }
        ...
        i.$GetAttributeEx = function (a, b) {
            return i.$GetAttribute(a, b) || i.$GetAttribute(a, "data-" + b)
        };
        ...
        i.$SetStyleClip = function (d, c) {
            if (c)d.style.clip = "rect(" + b.round(c.$Top) + "px " + b.round(c.$Right) + "px " + b.round(c.$Bottom) + "px " + b.round(c.$Left) + "px)"; else {
                var g = d.style.cssText, f = [new RegExp(/[\s]*clip: rect\(.*?\)[;]?/i), new RegExp(/[\s]*cliptop: .*?[;]?/i), new RegExp(/[\s]*clipright: .*?[;]?/i), new RegExp(/[\s]*clipbottom: .*?[;]?/i), new RegExp(/[\s]*clipleft: .*?[;]?/i)], e = K(g, f, "");
                a.$CssCssText(d, e)
            }
        };
        i.$GetNow = function () {
        ...
        i.$LoadImage = function (d, b) {
            if (i.$IsBrowserOpera() && j < 11.6 || !d)N(b, e); else {
                var a = new Image;
                a.onload = i.$CreateCallback(e, N, b, a);
                a.onabort = i.$CreateCallback(e, N, b, a, c);
                a.src = d
            }
        };
        ...
        i.$CssN = Q;
        i.$CssP = rb;
        i.$CssOverflow = l("overflow");
        i.$CssCssText = l("cssText");
        i.$CssTop = l("top", 2);
        i.$CssLeft = l("left", 2);
        i.$CssWidth = l("width", 2);
        i.$CssHeight = l("height", 2);
        i.$CssMarginLeft = l("marginLeft", 2);
        i.$CssMarginTop = l("marginTop", 2);
        i.$CssPosition = l("position");
        i.$CssDisplay = l("display");
        i.$CssZIndex = l("zIndex", 1);
        i.$CssFloat = function (b, a) {
            return G(b, r() ? "styleFloat" : "cssFloat", a)
        };
        i.$CssOpacity = function (b, a, c) {
            if (a != q)mb(b, a, c); else return kb(b)
        };
        var P = {$Opacity: i.$CssOpacity, $Top: i.$CssTop, $Left: i.$CssLeft, $Width: i.$CssWidth, $Height: i.$CssHeight, $Position: i.$CssPosition, $Display: i.$CssDisplay, $ZIndex: i.$CssZIndex}, u;

        function J() {
            if (!u)u = i.$Extend({$MarginTop: i.$CssMarginTop, $MarginLeft: i.$CssMarginLeft, $Clip: i.$SetStyleClip, $Transform: i.$SetStyleTransform}, P);
            return u
        }
            ...
            if (!E || y || G || j != n) {
                ...
                if (!E || y || G || p != t) {
                    if (x) {
                        ...
                        if (z.$Zoom)d.$Transform = {$Rotate: d.$Rotate || 0, $Scale: d.$Zoom, $OriginalWidth: g.$OriginalWidth, $OriginalHeight: g.$OriginalHeight};
                        if (x.$Clip && g.$Move) {
                            var v = d.$Clip.$Offset, D = (v.$Top || 0) + (v.$Bottom || 0), A = (v.$Left || 0) + (v.$Right || 0);
                            d.$Left = (d.$Left || 0) + A;
                            d.$Top = (d.$Top || 0) + D;
                            d.$Clip.$Left -= A;
                            d.$Clip.$Right -= A;
                        ...
                        if (d.$Clip && a.$CanClearClip() && !d.$Clip.$Top && !d.$Clip.$Left && d.$Clip.$Right == g.$OriginalWidth && d.$Clip.$Bottom == g.$OriginalHeight)d.$Clip = e;
    ...
    var s, k = g.$JssorSlideshowFormations$ = {};
    new function () {
        var q = 0, o = 1, w = 2, v = 3, I = 1, H = 2, J = 4, G = 8, O = 256, P = 512, N = 1024, M = 2048, z = M + I, y = M + H, E = P + I, C = P + H, D = O + J, A = O + G, B = N + J, F = N + G;
        ...
        k.$FormationSwirl = function (e) {
            var l = e.$Cols, m = e.$Rows, r = e.$Assembly, k = e.$Count, p = [], n = [], i = 0, a = 0, b = 0, f = l - 1, g = m - 1, h, d, j = 0;
            switch (r) {
                case z:
                    a = f;
                    b = 0;
        ...
        function K(g, f) {
            var e = {$Interval: f, $Duration: 1, $Delay: 0, $Cols: 1, $Rows: 1, $Opacity: 0, $Zoom: 0, $Clip: 0, $Move: d, $SlideOut: d, $FlyDirection: 0, $Reverse: d, $Formation: k.$FormationRandom, $Assembly: F, $ChessMode: {$Column: 0, $Row: 0}, $Easing: l.$EaseSwing, $Round: {}, $Blocks: [], $During: {}};
            a.$Extend(e, g);
            ...
            e.$GetBlocks = function (b, a) {
                ...
                if (!e.$Blocks[f]) {
                    ...
                    for (var c = 0; c < e.$Cols; c++)for (var d = 0; d < e.$Rows; d++)e.$Blocks[f][d + "," + c] = {$Top: d * a, $Right: c * b + b, $Bottom: d * a + a, $Left: c * b}
                }
                return e.$Blocks[f]
            };
            if (e.$Brother) {
        ...
        function L(D, k, f, y, m, l) {
            ...
            if (a.$IsBrowserIe9Earlier()) {
                var F = !k["no-image"], C = a.$FindChildrenByTag(k, e, c);
                a.$Each(C, function (b) {
                    (F || b["jssor-slider"]) && a.$CssOpacity(b, a.$CssOpacity(b), c)
                })
            }
            a.$Each(q, function (e, k) {
                a.$Each(e, function (N) {
                    var S = N[0], R = N[1], z = S + "," + R, u = d, x = d, A = d;
                    if (r && R % 2) {
                    ...
                    if (f.$Zoom || f.$Rotate) {
                        var P = c;
                        if (a.$IsBrowserIE() && a.$GetBrowserEngineVersion() < 9)if (f.$Cols * f.$Rows > 1)P = d; else Q = d;
                        if (P) {
                    ...
                    for (var C = f.$FramesCount, J = 0; J <= C; J++) {
                        ...
                        a.$Each(t, function (g, c) {
                            var m = f.$EasingInstance[c] || f.$EasingInstance.$Default, l = m[f.$Round[c] || 1], k = f.$During[c] || [0, 1], d = (J / C - k[0]) / k[1] * C;
                            d = b.round(b.min(C, b.max(d, 0)));
                            var j = l[d];
                            if (a.$IsNumeric(g))e[c] = h[c] + g * j; else {
                                var i = e[c] = a.$Extend({}, h[c]);
                                i.$Offset = [];
                        ...
                        if (h.$Zoom)e.$Transform = {$Rotate: e.$Rotate || 0, $Scale: e.$Zoom, $OriginalWidth: m, $OriginalHeight: l};
                        if (e.$Clip && f.$Move) {
        ...
        g.$JssorSlideshowRunner$ = function (h, l, i, n, p) {
            ...
            d.$Initialize = function (w, x, n, p, a) {
                ...
                m["no-image"] = !p.$Image;
                j["no-image"] = !n.$Image;
                var q = m, r = j, v = a, e = a.$Brother || K({}, g);
                if (!a.$SlideOut) {
                    q = j;
                    r = m
                }
                var s = e.$Shift || 0;
                f = new L(h, r, e, b.max(s - e.$Interval, 0), l, i);
                c = new L(h, q, v, b.max(e.$Interval - s, 0), l, i);
                f.$ShowFrame(0);
                c.$ShowFrame(0);
        ...
        function n(o, bc) {
            ...
            function wc() {
                ...
                a.$OnPositionChange = function (d, a) {
                    ...
                    if (e != a && a > d)e++;
                    Pb(e, c);
                    i.$TriggerEvent(n.$EVT_POSITION_CHANGE, u(a), u(d), a, d)
                }
            }

            function vc() {
                var b = this;
                j.call(b, 0, 0, {$LoopLength: s});
                a.$Each(C, function (a) {
                    T & 1 && a.$SetLoopLength(s);
                    b.$Chain(a);
                    a.$Shift(hb / Wb)
                })
            }
            ...
            function uc() {
                var a = this, b = Ob.$Elmt;
                j.call(a, -1, 2, {$Easing: l.$EaseLinear, $Setter: {$Position: Ub}, $LoopLength: s}, b, {$Position: 1}, {$Position: -1});
                a.$Wrapper = b
            }
            ...
            function jc(o, m) {
                ...
                a.$OnStart = function () {
                    Q = c;
                    V = e;
                    i.$TriggerEvent(n.$EVT_SWIPE_START, u(y.$GetPosition()), y.$GetPosition())
                };
                a.$OnStop = function () {
                    Q = d;
                    l = d;
                    var a = y.$GetCurrentSlideInfo();
                    i.$TriggerEvent(n.$EVT_SWIPE_END, u(y.$GetPosition()), y.$GetPosition());
                    !a.$Position && yc(a.$VirtualIndex, q)
                };
                a.$OnPositionChange = function (d, c) {
                    var a;
                    if (l)a = b; else {
                        a = g;
                        if (h)a = k.$SlideEasing(c / h) * (g - f) + f
                    }
                    y.$GoToPosition(a)
                };
            ...
            function tc(p, o) {
                var f = this, t, w, K, y, g, z = [], T, r, X, I, P, F, l, v, h, hb;
                j.call(f, -x, x + 1, {$SlideItemAnimator: c});
                function E(a) {
                    w && w.$Revert();
                    t && t.$Revert();
                    W(p, a);
                ...
                function L(o, q, m) {
                    if (!I) {
                        I = c;
                        if (g && m) {
                            var e = m.width, b = m.height, l = e, j = b;
                            if (e && b && k.$FillMode) {
                                if (k.$FillMode & 3 && (!(k.$FillMode & 4) || e > J || b > H)) {
                                    var h = d, p = J / H * b / e;
                                    if (k.$FillMode & 1)h = p > 1; else if (k.$FillMode & 2)h = p < 1;
                                    l = h ? e * H / b : J;
                                    j = h ? H : b * J / e
                                }
                                a.$CssWidth(g, l);
                            ...
                            i.$TriggerEvent(n.$EVT_LOAD_END, Zb)
                        }
                    }
                    a.$HideElement(q);
                    o && o(f)
                ...
                function Y(b, c, d, e) {
                    if (e == V && q == o && R)if (!xc) {
                        var a = u(b);
                        A.$Initialize(a, o, c, f, d);
                        c.$HideContentForSlideshow();
                        ab.$Locate(a, 1);
                        ab.$GoToPosition(a);
                        B.$PlayCarousel(b, b, 0)
                    }
                }
                ...
                function cb(b) {
                    if (b == V && q == o) {
                        if (!l) {
                            var a = e;
                            if (A)if (A.$Index == o)a = A.$GetProcessor(); else A.$Clear();
                            Z();
                            l = new rc(o, a, f.$GetCaptionSliderIn(), f.$GetCaptionSliderOut());
                            l.$SetPlayer(h)
                        }
                ...
                function Q(d, c) {
                    if (d == o) {
                        if (d != c)C[c] && C[c].$ParkOut();
                        h && h.$Enable();
                        var j = V = a.$GetNow();
                        f.$LoadImage(a.$CreateCallback(e, cb, j))
                    } else {
                        var i = b.abs(o - d), g = x + k.$LazyLoading;
                        (!P || i <= g || s - i <= g) && f.$LoadImage()
                    }
                }
                ...
                function O(b) {
                    if (U)a.$CancelEvent(b); else i.$TriggerEvent(n.$EVT_CLICK, o, b)
                }
                ...
                f.$LoadImage = function (d, b) {
                    b = b || y;
                    if (z.length && !I) {
                        a.$ShowElement(b);
                        if (!X) {
                            X = c;
                            i.$TriggerEvent(n.$EVT_LOAD_START);
                            a.$Each(z, function (b) {
                                if (!b.src) {
                                    b.src = a.$GetAttributeEx(b, "src2");
                                    a.$CssDisplay(b, b["display-origin"])
                                }
                            })
                        }
                        a.$LoadImages(z, g, a.$CreateCallback(e, L, d, b))
                    } else L(d, b)
                };
                f.$GoForNextSlide = function () {
                    if (A) {
                        var b = A.$GetTransition(s);
                        if (b) {
                            var f = V = a.$GetNow(), c = o + 1, d = C[u(c)];
                            return d.$LoadImage(a.$CreateCallback(e, Y, c, d, b, f), y)
                        }
                    }
                    bb(q + k.$AutoPlaySteps)
                };
                ...
                function W(b, f, e) {
                    if (b["jssor-slider"] || a.$GetAttribute(b, "u") == "thumb")return;
                    e = e || 0;
                    if (!F) {
                        if (b.tagName == "IMG") {
                            z.push(b);
                        ...
                        if (k.$HWA && a.$GetWebKitVersion() > 0)(!G || a.$GetWebKitVersion() < 534 || !eb) && a.$EnableHWA(b)
                    }
                    var h = a.$GetChildren(b);
                    a.$Each(h, function (h) {
                        var j = a.$GetAttributeEx(h, "u");
                        if (j == "player" && !v) {
                            v = h;
                            if (v.pInstance)N(); else a.$AddEvent(v, "dataavailable", N)
                        }
                        if (j == "caption") {
                            if (!a.$IsBrowserIE() && !f) {
                        ...
                        } else if (!F && !e && !g && a.$GetAttributeEx(h, "u") == "image") {
                            g = h;
                            if (g) {
                                if (g.tagName == "A") {
                                    T = g;
                                    a.$SetStyles(T, S);
                                    r = a.$CloneNode(g, d);
                                    a.$AddEvent(r, "click", O);
                                    a.$SetStyles(r, S);
                                    a.$CssDisplay(r, "block");
                                    a.$CssOpacity(r, 0);
                                    a.$Css(r, "backgroundColor", "#000");
                ...
                f.$Index = o;
                m.call(f);
                var D = a.$FindFirstChildByAttribute(p, "thumb");
                if (D) {
                    f.$Thumb = a.$CloneNode(D, c);
                    a.$RemoveAttribute(D, "id");
                    a.$HideElement(D)
                }
                a.$ShowElement(p);
                y = a.$CloneNode(db, c);
            ...
            function rc(g, r, v, u) {
                var b = this, m = 0, x = 0, o, h, e, f, l, s, w, t, p = C[g];
                j.call(b, 0, 0);
                function y() {
                    a.$ClearChildren(N);
                    ac && l && p.$Link && a.$AppendChild(N, p.$Link);
                    a.$ShowElement(N, l || !p.$Image)
                }

                function z() {
                    if (s) {
                        s = d;
                        i.$TriggerEvent(n.$EVT_ROLLBACK_END, g, e, m, h, e, f);
                        b.$GoToPosition(h)
                    }
                    b.$Replay()
                }
                    ...
                    if (!I && !Q && !t && q == g) {
                        if (!a) {
                            if (o && !l) {
                                ...
                                i.$TriggerEvent(n.$EVT_SLIDESHOW_START, g, m, x, o, f)
                            }
                            y()
                        }
                        var d, k = n.$EVT_STATE_CHANGE;
                        if (a != f)if (a == e)d = f; else if (a == h)d = e; else if (!a)d = h; else if (a > e) {
                            s = c;
                            d = e;
                            k = n.$EVT_ROLLBACK_START
                        } else d = b.$GetPlayToPosition();
                        i.$TriggerEvent(k, g, a, m, h, e, f);
                        var j = R && (!Rb || Z);
                        if (a == f)j && p.$GoForNextSlide(); else(j || a != e) && b.$PlayToPosition(d, z)
                    }
                };
                b.$Abort = function () {
                    A && A.$Index == g && A.$Clear();
                    var a = b.$GetPosition_Display();
                    a < f && i.$TriggerEvent(n.$EVT_STATE_CHANGE, g, -a - 1, m, h, e, f)
                };
                b.$OpenSlideshowPanel = function (b) {
                    r && a.$CssOverflow(ib, b && r.$Transition.$Outside ? "" : "hidden")
                };
                b.$OnInnerOffsetChange = function (b, a) {
                    if (l && a >= o) {
                        ...
                        A.$Clear();
                        i.$TriggerEvent(n.$EVT_SLIDESHOW_END, g, m, x, o, f)
                    }
                    i.$TriggerEvent(n.$EVT_PROGRESS_CHANGE, g, a, m, h, e, f)
                };
                b.$SetPlayer = function (a) {
                    if (a && !w) {
                        w = a;
                        a.$On($JssorPlayer$.$EVT_SWITCH, B)
                    }
                };
                r && b.$Chain(r);
            ...
            function Ub(c, g) {
                var f = w > 0 ? w : k.$PlayOrientation, d = b.round(yb * g * (f & 1)), e = b.round(zb * g * (f >> 1 & 1));
                if (a.$IsBrowserIE() && a.$GetBrowserVersion() >= 10 && a.$GetBrowserVersion() < 11)c.style.msTransform = "translate(" + d + "px, " + e + "px)"; else if (a.$IsBrowserChrome() && a.$GetBrowserVersion() >= 30 && a.$GetBrowserVersion() < 34) {
            ...
            function oc(b) {
                ...
                gb = 0;
                D = y.$GetPosition();
                i.$TriggerEvent(n.$EVT_DRAG_START, u(D), D, b)
            }

            function Xb(e) {
                if (I && (!a.$IsBrowserIe9Earlier() || e.button)) {
                    var f;
                    if (G) {
                        var n = e.touches;
                    ...
                    if (f) {
                        var l = f.x - sb, m = f.y - tb;
                        if (b.floor(D) != D)w = w || k.$PlayOrientation & K;
                        if ((l || m) && !w) {
                            if (K == 3)if (b.abs(m) > b.abs(l))w = 2; else w = 1; else w = K;
                            if (G && w == 1 && b.abs(m) - b.abs(l) > 3)xb = c
                        }
                        if (w) {
                            var d = m, j = zb;
                            if (w == 1) {
                            ...
                            if (E - cb < -2)gb = 1; else if (E - cb > 2)gb = 0;
                            cb = E;
                            E = d;
                            qb = D - E / j / (lb || 1);
                            if (E && w && !xb) {
                                a.$CancelEvent(e);
                                if (!Q)B.$StandBy(qb); else B.$SetStandByPosition(qb)
            ...
            function Cb(h) {
                ...
                if (I) {
                    I = d;
                    a.$GetNow();
                    a.$RemoveEvent(f, mb, Xb);
                    U = E;
                    U && a.$CancelEvent(h);
                    B.$Stop();
                    var e = y.$GetPosition();
                    i.$TriggerEvent(n.$EVT_DRAG_END, u(e), e, u(D), D, h);
                    var c = b.floor(D);
                    if (b.abs(E) >= k.$MinDragOffsetToSlide) {
                        c = b.floor(e);
                        c += gb
                    }
                    if (!(T & 1))c = b.min(s - x, b.max(c, 0));
                    var g = b.abs(c - e);
                    g = 1 - b.pow(1 - g, 5);
                    if (!U && ob)B.$Continue(Gb); else if (e == c) {
                        rb.$EnablePlayer();
                        rb.$TryActivate()
                    } else B.$PlayCarousel(e, c, g * Qb)
                }
            }
            ...
            function yc(a, b) {
                w = 0;
                ic(a);
                i.$TriggerEvent(n.$EVT_PARK, u(a), b)
            }
            ...
            function fc(a, c) {
                if (c)if (!T) {
                    a = b.min(b.max(a + vb, 0), s - 1);
                    c = d
                } else if (T & 2) {
                    a = u(a + vb);
                    c = d
                }
                bb(a, k.$SlideDuration, c)
            }

            function wb() {
                a.$Each(P, function (a) {
                    a.$Show(a.$Options.$ChanceToShow > Z)
                })
            }
            ...
            function ec() {
                S = {$Width: J, $Height: H, $Top: 0, $Left: 0};
                a.$Each(X, function (b) {
                    a.$SetStyles(b, S);
                    a.$CssPosition(b, "absolute");
                    a.$CssOverflow(b, "hidden");
            ...
            function bb(h, g, l) {
                if (Mb && (!I || k.$NaviQuitDrag)) {
                    Q = c;
                    I = d;
                    B.$Stop();
                    if (a.$IsUndefined(g))g = Qb;
                    var f = Db.$GetPosition_Display(), e = h;
                    if (l) {
                        e = f + h;
                        if (h > 0)e = b.ceil(e); else e = b.floor(e)
                    }
                    if (!(T & 1)) {
                        e = u(e);
                        e = b.max(0, b.min(e, s - x))
                    }
                    var j = (e - f) % s;
                    e = f + j;
                    var i = f == e ? 0 : g * b.abs(j);
                    i = b.min(i, g * x * 1.5);
                    B.$PlayCarousel(f, e, i || 1)
                }
            }
            ...
            i.$SetSlideshowTransitions = function (a) {
                k.$SlideshowOptions.$Transitions = a
            };
            i.$SetCaptionTransitions = function (b) {
                M.$CaptionTransitions = b;
                M.$Version = a.$GetNow()
            };
            ...
            i.$LastDragSucceded = function () {
                return U
            };
            i.$GetOriginalWidth = function () {
                return a.$CssWidth(v || o)
            };
            i.$GetOriginalHeight = function () {
                return a.$CssHeight(v || o)
            };
            i.$GetScaleWidth = function () {
                return a.$CssWidth(o)
            };
            i.$GetScaleHeight = function () {
                return a.$CssHeight(o)
            };
            i.$SetScaleWidth = function (c) {
                if (!v) {
                    var b = a.$CloneNode(o, d);
                    ...
                    a.$CssTop(v, 0);
                    a.$CssLeft(v, 0);
                    a.$CssWidth(v, a.$CssWidth(o));
                    a.$CssHeight(v, a.$CssHeight(o));
                    a.$SetStyleTransformOrigin(v, "0 0");
                    a.$AppendChild(v, b);
                    var f = a.$GetChildren(o);
                    a.$AppendChild(o, v);
                    var e = {navigator: Y && Y.$Scale == d, arrowleft: L && L.$Scale == d, arrowright: L && L.$Scale == d, thumbnavigator: F && F.$Scale == d, thumbwrapper: F && F.$Scale == d};
                    a.$Each(f, function (c) {
                        a.$AppendChild(e[a.$GetAttributeEx(c, "u")] ? o : b, c)
                    });
                    a.$ShowElement(b);
                    a.$ShowElement(v)
                }
                ...
                a.$CssWidth(o, c);
                a.$CssHeight(o, lb * a.$CssHeight(v));
                a.$Each(P, function (a) {
                    a.$Relocate()
                })
            };
            i.$GetVirtualIndex = function (a) {
                var d = b.ceil(u(hb / Wb)), c = u(a - q + d);
                if (c > x) {
                    if (a - q > s / 2)a -= s; else if (a - q <= -s / 2)a += s
                } else a = q + c - d;
                return a
            };
            m.call(this);
            i.$Elmt = o = a.$GetElement(o);
            var k = a.$Extend({$FillMode: 0, $LazyLoading: 1, $StartIndex: 0, $AutoPlay: d, $Loop: 1, $HWA: c, $NaviQuitDrag: c, $AutoPlaySteps: 1, $AutoPlayInterval: 3e3, $PauseOnHover: 1, $SlideDuration: 500, $SlideEasing: l.$EaseOutQuad, $MinDragOffsetToSlide: 20, $SlideSpacing: 0, $DisplayPieces: 1, $ParkingPosition: 0, $UISearchMode: 1, $PlayOrientation: 1, $DragOrientation: 1}, bc), fb = k.$SlideshowOptions, M = a.$Extend({$Class: t, $PlayInMode: 1, $PlayOutMode: 1}, k.$CaptionSliderOptions), Y = k.$BulletNavigatorOptions, L = k.$ArrowNavigatorOptions, F = k.$ThumbnailNavigatorOptions, W = k.$UISearchMode, v, z = a.$FindFirstChildByAttribute(o, "slides", e, W), db = a.$FindFirstChildByAttribute(o, "loading", e, W) || a.$CreateDivElement(f), Ib = a.$FindFirstChildByAttribute(o, "navigator", e, W), Yb = a.$FindFirstChildByAttribute(o, "arrowleft", e, W), Vb = a.$FindFirstChildByAttribute(o, "arrowright", e, W), Fb = a.$FindFirstChildByAttribute(o, "thumbnavigator", e, W), hc = a.$CssWidth(z), gc = a.$CssHeight(z), S, X = [], qc = a.$GetChildren(z);
            a.$Each(qc, function (b) {
                b.tagName == "DIV" && !a.$GetAttributeEx(b, "u") && X.push(b)
            });
            var q = -1, vb, rb, s = X.length, J = k.$SlideWidth || hc, H = k.$SlideHeight || gc, Sb = k.$SlideSpacing, yb = J + Sb, zb = H + Sb, Wb = k.$PlayOrientation == 1 ? yb : zb, x = b.min(k.$DisplayPieces, s), ib, w, K, xb, G, P = [], Lb, Nb, Kb, ac, xc, R, Rb = k.$PauseOnHover, Qb = k.$SlideDuration, pb, eb, hb, Mb = x < s, T = Mb ? k.$Loop : 0, O, U, Z = 1, Q, I, V, sb = 0, tb = 0, E, cb, gb, Db, y, ab, B, Ob = new kc, lb;
            R = k.$AutoPlay;
            i.$Options = bc;
            ec();
            o["jssor-slider"] = c;
            a.$CssZIndex(z, a.$CssZIndex(z) || 0);
            a.$CssPosition(z, "absolute");
            ib = a.$CloneNode(z);
            a.$InsertBefore(a.$GetParentNode(z), ib, z);
            if (fb) {
                ac = fb.$ShowLink;
                pb = fb.$Class;
                eb = x == 1 && s > 1 && pb && (!a.$IsBrowserIE() || a.$GetBrowserVersion() >= 8)
            }
            hb = eb || x >= s || !(T & 1) ? 0 : k.$ParkingPosition;
            O = x > 1 || hb ? k.$PlayOrientation : -1 & k.$DragOrientation;
            var ub = z, C = [], A, N, Bb = "mousedown", mb = "mousemove", Eb = "mouseup", kb, D, ob, Gb, qb;
            if (g.navigator.msPointerEnabled) {
                ...
                if (O) {
                    var Ab = "none";
                    if (O == 1)Ab = "pan-y"; else if (O == 2)Ab = "pan-x";
                    a.$SetAttribute(ub.style, "-ms-touch-action", Ab)
                }
            ...
            ab = new uc;
            if (eb)A = new pb(Ob, J, H, fb, G);
            a.$AppendChild(ib, ab.$Wrapper);
            a.$CssOverflow(z, "hidden");
            N = Tb();
            a.$Css(N, "backgroundColor", "#000");
            a.$CssOpacity(N, 0);
            a.$InsertBefore(ub, N, ub.firstChild);
            for (var nb = 0; nb < X.length; nb++) {
                var sc = X[nb], Zb = new tc(sc, nb);
                C.push(Zb)
            }
            a.$HideElement(db);
            Db = new vc;
            ...
            if (L && Yb && Vb) {
                Nb = new L.$Class(Yb, Vb, L);
                P.push(Nb)
            }
            if (Fb && F) {
                F.$StartIndex = k.$StartIndex;
                Kb = new F.$Class(Fb, F);
                P.push(Kb)
            }
            a.$Each(P, function (a) {
                a.$Reset(s, C, db);
                a.$On(p.$NAVIGATIONREQUEST, fc)
            });
            i.$SetScaleWidth(i.$GetOriginalWidth());
            a.$AddEvent(o, "mouseout", dc);
            a.$AddEvent(o, "mouseover", cc);
            wb();
            k.$ArrowKeyNavigation && a.$AddEvent(f, "keydown", function (a) {
                if (a.keyCode == r.$LEFT)jb(-1); else a.keyCode == r.$RIGHT && jb(1)
            });
            B.$PlayCarousel(k.$StartIndex, k.$StartIndex, 0)
        }
    ...
    g.$JssorBulletNavigator$ = function (f, D) {
        ...
        m.call(h);
        f = a.$GetElement(f);
        var t, u, s, r, l = 0, g, n, k, y, z, j, i, q, o, C = [], A = [];

        function x(a) {
            a != -1 && A[a].$Activate(a == l)
        }

        function v(a) {
            h.$TriggerEvent(p.$NAVIGATIONREQUEST, a * n)
        }
        ...
        h.$Relocate = function () {
            if (!B || g.$Scale == d) {
                g.$AutoCenter & 1 && a.$CssLeft(f, (a.$CssWidth(a.$GetParentNode(f)) - u) / 2);
                g.$AutoCenter & 2 && a.$CssTop(f, (a.$CssHeight(a.$GetParentNode(f)) - s) / 2);
                B = c
            }
        };
        var w;
        h.$Reset = function (D) {
            if (!w) {
                t = b.ceil(D / n);
                l = 0;
                var p = q + y, r = o + z, m = b.ceil(t / k) - 1;
                u = q + p * (!j ? m : k - 1);
                s = o + r * (j ? m : k - 1);
                a.$CssWidth(f, u);
                a.$CssHeight(f, s);
                for (var d = 0; d < t; d++) {
                    var B = a.$CreateSpanElement();
                    a.$SetInnerText(B, d + 1);
                    var h = a.$BuildElement(i, "NumberTemplate", B, c);
                    a.$CssPosition(h, "absolute");
                    var x = d % (m + 1);
                    a.$CssLeft(h, !j ? p * x : d % k * p);
                    a.$CssTop(h, j ? r * x : b.floor(d / (m + 1)) * r);
                    a.$AppendChild(f, h);
                    C[d] = h;
                    g.$ActionMode & 1 && a.$AddEvent(h, "click", a.$CreateCallback(e, v, d));
                    g.$ActionMode & 2 && a.$AddEvent(h, "mouseover", a.$CreateCallback(e, v, d));
                    A[d] = a.$Buttonize(h)
                }
                w = c
            }
        };
        h.$Options = g = a.$Extend({$SpacingX: 0, $SpacingY: 0, $Orientation: 1, $ActionMode: 1}, D);
        i = a.$FindFirstChildByAttribute(f, "prototype");
        q = a.$CssWidth(i);
        o = a.$CssHeight(i);
        a.$RemoveChild(f, i);
        n = g.$Steps || 1;
    ...
    g.$JssorArrowNavigator$ = function (b, g, s) {
        var f = this;
        m.call(f);
        var i, h, j, q = a.$GetParentNode(b), o = a.$CssWidth(b), l = a.$CssHeight(b);

        function k(a) {
            f.$TriggerEvent(p.$NAVIGATIONREQUEST, a, c)
        }
        ...
        f.$Relocate = function () {
            if (!r || h.$Scale == d) {
                var f = a.$CssWidth(q), e = a.$CssHeight(q);
                if (h.$AutoCenter & 1) {
                    a.$CssLeft(b, (f - o) / 2);
                    a.$CssLeft(g, (f - o) / 2)
                }
        ...
        f.$Reset = function (d) {
            i = 0;
            if (!n) {
                a.$AddEvent(b, "click", a.$CreateCallback(e, k, -j));
                a.$AddEvent(g, "click", a.$CreateCallback(e, k, j));
                a.$Buttonize(b);
                a.$Buttonize(g);
                n = c
            }
        };
        f.$Options = h = a.$Extend({$Steps: 1}, s);
        j = h.$Steps
    };
    g.$JssorThumbnailNavigator$ = function (i, A) {
        var h = this, x, l, e, u = [], y, w, f, n, o, t, r, k, q, g, j;
        m.call(h);
        i = a.$GetElement(i);
        function z(n, d) {
            var g = this, b, m, k;
            ...
            function i() {
                if (!q.$LastDragSucceded()) {
                    var a = (f - d % f) % f, b = q.$GetVirtualIndex((d + a) / f), c = b * f - a;
            ...
            e.$ActionMode & 2 && a.$AddEvent(b, "mouseover", i)
        }
        ...
        h.$Reset = function (F, D) {
            if (!v) {
                ...
                l = -1;
                k = b.min(k, D.length);
                var h = e.$Orientation & 1, p = t + (t + n) * (f - 1) * (1 - h), m = r + (r + o) * (f - 1) * h, C = p + (p + n) * (k - 1) * h, A = m + (m + o) * (k - 1) * (1 - h);
                a.$CssPosition(g, "absolute");
                ...
                var E = a.$Extend({$AutoPlay: d, $NaviQuitDrag: d, $SlideWidth: p, $SlideHeight: m, $SlideSpacing: n * h + o * (1 - h), $MinDragOffsetToSlide: 12, $SlideDuration: 200, $PauseOnHover: 1, $PlayOrientation: e.$Orientation, $DragOrientation: e.$DisableDrag ? 0 : e.$Orientation}, e);
                q = new s(i, E);
                v = c
            }
        };
    ...
    g.$JssorCaptionSlider$ = function (p, k, g) {
        var d = this, h, f = k.$CaptionTransitions, o = {$Transition: "t", $Delay: "d", $Duration: "du", $ScaleHorizontal: "x", $ScaleVertical: "y", $Rotate: "r", $Zoom: "z", $Opacity: "f", $BeginTime: "b"}, e = {$Default: function (b, a) {
        ...
        function m(r, n) {
            ...
            a.$Each(q, function (b) {
                var c = [];
                c.$Elmt = b;
                var f = a.$GetAttributeEx(b, "u") == "caption";
                a.$Each(g ? [0, 3] : [2], function (o, p) {
                    if (f) {
                        var l, i;
                        if (o != 2 || !a.$GetAttributeEx(b, "t3")) {
                            i = h(b, o);
                            if (o == 2 && !i.$Transition) {
        ...
        function n(E, d, F) {
            var h = {$Easing: d.$Easing, $Round: d.$Round, $During: d.$During, $Reverse: g && !F, $Optimize: c}, k = E, y = a.$GetParentNode(E), o = a.$CssWidth(k), n = a.$CssHeight(k), u = a.$CssWidth(y), t = a.$CssHeight(y), f = {}, l = {}, m = d.$ScaleClip || 1;
            ...
            if (d.$Zoom || d.$Rotate) {
                ...
                var z = {$Top: 0, $Right: o, $Bottom: n, $Left: 0}, D = a.$Extend({}, z), e = D.$Offset = {}, C = d.$Clip & 4, v = d.$Clip & 8, A = d.$Clip & 1, x = d.$Clip & 2;
                if (C && v) {
                    e.$Top = n / 2 * m;
                    e.$Bottom = -e.$Top
